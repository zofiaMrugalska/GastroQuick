...
async function sendPasswordResetCode(toEmail, resetPasswordVerificationCode, resetLink) {
  try {
    let mailOptions = await transporter.sendMail({
      from: "noreply@flowblog.com",
      to: toEmail,
      ...
      <p>Your Verification Code is: <strong>${resetPasswordVerificationCode}</strong></p>
...
module.exports = { confirmEmail, sendPasswordResetCode };
